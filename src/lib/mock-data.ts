...
export const mockProducts: Product[] = [
  {
    id: 'prod-1',
    name: 'Quantum-X HD Smart TV 55"',
    slug: 'quantum-x-hd-smart-tv-55',
    category: 'Televisions',
    description: 'Experience stunning 4K HDR with our latest Quantum-X Smart TV. Built-in streaming apps and voice remote.',
    price: 65000.00,
    stockQuantity: 22,
  ...
  {
    id: 'prod-6',
    name: 'Aura-Glow Smart LED TV Backlight',
    slug: 'aura-glow-led-backlight',
    category: 'Accessories',
    description: 'Create immersive viewing experiences with reactive RGB backlighting for your TV. Syncs with your screen.',
    price: 5500.00,
    stockQuantity: 50,
